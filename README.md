...
- `dbchat-3.0.0.jar` - Basic version (PostgreSQL, SQLite, H2, HSQLDB, CSV)
...
(Optional) For simplicity rename it to `dbchat-3.0.0.jar` so you can follow the rest of the commands here without needing to adjust them to your version.
