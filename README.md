...
- [dbchat-4.0.0-basic.jar](https://github.com/skanga/dbchat/releases/download/v4.0.0/dbchat-4.0.0-basic.jar) - Basic version (PostgreSQL, SQLite, H2, HSQLDB, CSV)   `<-- Start here`
- [dbchat-4.0.0-standard.jar](https://github.com/skanga/dbchat/releases/download/v4.0.0/dbchat-4.0.0-standard.jar) - Standard version (add MySQL, MariaDB, ClickHouse)
- [dbchat-4.0.0-enterprise.jar](https://github.com/skanga/dbchat/releases/download/v4.0.0/dbchat-4.0.0-enterprise.jar) - Enterprise version (add Oracle, SQL Server, DB2)
