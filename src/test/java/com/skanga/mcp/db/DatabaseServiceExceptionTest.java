...
class DatabaseServiceExceptionTest {
    ...
    @Test
    void testValidateSqlQuery_EmptyQuery() throws SQLException {
        databaseService = new DatabaseService(testConfig, mockDataSource);
    ...
    @Test
    void testValidateSqlQuery_NullQuery() throws SQLException {
        databaseService = new DatabaseService(testConfig, mockDataSource);
    ...
    @Test
    void testValidateSqlQuery_WhitespaceOnlyQuery() throws SQLException {
        databaseService = new DatabaseService(testConfig, mockDataSource);
    ...
    @Test
    void testValidateSqlQuery_DangerousOperations() throws SQLException {
        databaseService = new DatabaseService(testConfig, mockDataSource);
    ...
    @Test
    void testValidateSqlQuery_DangerousOperations_CaseInsensitive() throws SQLException {
        databaseService = new DatabaseService(testConfig, mockDataSource);
    ...
    @Test
    void testValidateSqlQuery_SqlComments() throws SQLException {
        databaseService = new DatabaseService(testConfig, mockDataSource);
    ...
    void testReadResource_ConnectionFailure() throws SQLException {
        ...
        SQLException exception = assertThrows(SQLException.class, () -> {
            databaseService.readResource("database://info");
        });
    ...
    void testGetTableResource_ConnectionFailure() throws SQLException {
        ...
        SQLException exception = assertThrows(SQLException.class, () -> {
            databaseService.readResource("database://table/test_table");
        });
    ...
    void testGetSchemaResource_ConnectionFailure() throws SQLException {
        ...
        SQLException exception = assertThrows(SQLException.class, () -> {
            databaseService.readResource("database://schema/test_schema");
        });
