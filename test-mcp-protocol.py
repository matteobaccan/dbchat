...
class MCPTester:
    ...
    def create_standard_test_cases(self):
        ...
        # Test 6: Call Tool with Empty SQL (should return error)
        self.add_test_case(
        ...
        # Test 7: Read Database Info Resource
        self.add_test_case(
    ...
    def validate_json_rpc(self, response: Dict[str, Any]) -> List[str]:
    ...
    def validate_mcp_specific(self, test_case: TestCase, response: Dict[str, Any]) -> List[str]:
        ...
        if test_case.name == "Initialize Protocol" and "result" in response:
        ...
        elif test_case.name == "List Tools" and "result" in response:
            result = response["result"]
        ...
        elif test_case.name == "Call Query Tool" and "result" in response:
            result = response["result"]
    ...
    def run_test_case(self, test_case: TestCase) -> TestCase:
        ...
        try:
            ...
            # JSON-RPC validation
            errors.extend(self.validate_json_rpc(response))
